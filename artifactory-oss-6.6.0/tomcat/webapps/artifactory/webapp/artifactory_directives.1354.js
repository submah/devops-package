...
/***/ (function(module, exports, __webpack_require__) {
	...
	var jfAccordion = __webpack_require__(90).jfAccordion;
	
	var jfFooter = __webpack_require__(91).jfFooter;
	
	var jfHeader = __webpack_require__(92).jfHeader;
	
	var jfMessages = __webpack_require__(95).jfMessages;
	
	var jfHeaderSearch = __webpack_require__(96).jfHeaderSearch;
	
	var jfBrowseFiles = __webpack_require__(97).jfBrowseFiles;
	
	var jfSwitchToggle = __webpack_require__(98).jfSwitchToggle;
	
	var dynamicDirective = _interopRequire(__webpack_require__(99));
	
	var jfMultiDeploy = __webpack_require__(100).jfMultiDeploy;
	
	var jfSingleDeploy = __webpack_require__(102).jfSingleDeploy;
	
	var jfPrint = __webpack_require__(103).jfPrint;
	
	var jfAutoFocus = __webpack_require__(104).jfAutoFocus;
	
	var jfBodyClass = __webpack_require__(105).jfBodyClass;
	
	var jfInputTextV2 = __webpack_require__(106).jfInputTextV2;
	
	var jfCronFormatter = __webpack_require__(107).jfCronFormatter;
	
	var jfBreadcrumb = __webpack_require__(108).jfBreadcrumb;
	
	var jfSpinner = __webpack_require__(109).jfSpinner;
	
	var jfDisableFeature = __webpack_require__(110).jfDisableFeature;
	
	var jfHideForAol = __webpack_require__(111).jfHideForAol;
	
	var jfFileDrop = __webpack_require__(112).jfFileDrop;
	
	var rtfactStorageViewer = __webpack_require__(113).rtfactStorageViewer;
	
	var rtfactStorageElement = __webpack_require__(115).rtfactStorageElement;
	
	var rtfactStorageUsage = __webpack_require__(117).rtfactStorageUsage;
	
	var jfValidatorName = __webpack_require__(118).jfValidatorName;
	
	var jfValidatorNamePrefixNotNumeric = __webpack_require__(119).jfValidatorNamePrefixNotNumeric;
	
	var jfValidatorUniqueId = __webpack_require__(120).jfValidatorUniqueId;
	
	var jfValidatorXmlName = __webpack_require__(121).jfValidatorXmlName;
	
	var jfValidatorCron = __webpack_require__(122).jfValidatorCron;
	
	var jfValidatorLdapUrl = __webpack_require__(123).jfValidatorLdapUrl;
	
	var jfValidatorPathPattern = __webpack_require__(124).jfValidatorPathPattern;
	
	var jfValidatorIntValue = __webpack_require__(125).jfValidatorIntValue;
	
	var jfValidatorMaxTextLength = __webpack_require__(126).jfValidatorMaxTextLength;
	
	var jfSpecialChars = __webpack_require__(127).jfSpecialChars;
	
	var jfRepokeyValidator = __webpack_require__(128).jfRepokeyValidator;
	
	var jfValidatorDateFormat = __webpack_require__(130).jfValidatorDateFormat;
	
	var jfValidatorReverseProxyPort = __webpack_require__(131).jfValidatorReverseProxyPort;
	
	var jfManageProLicense = __webpack_require__(132).jfManageProLicense;
	
	var jfManageHaLicenses = __webpack_require__(133).jfManageHaLicenses;
	
	var jfNews = __webpack_require__(134).jfNews;
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var HELP = _interopRequire(__webpack_require__(94));
	...
	var jfHeaderController = (function () {
	    function jfHeaderController($scope, $q, User, $state, $stateParams, $timeout, $window, GeneralConfigDao, FooterDao, JFrogEventBus, ArtifactoryFeatures, $rootScope, $location, $http, ArtifactoryState, ArtifactoryHttpClient, OnBoardingWizard, GoogleAnalytics) {
	        ...
	        this.defaultLogoUrl = "images/artifactory_logo.1354.svg";
	        this.HELP = HELP;
	    ...
	    _createClass(jfHeaderController, {
	        ...
	        _getFooterData: {
	            value: function _getFooterData(force) {
	                ...
	                this.footerDao.get(force).then(function (footerData) {
	                    _this.$window.document.title = footerData.serverName ? footerData.serverName : "Artifactory";
	                    ...
	                    } else if (footerData.logoUrl) _this.logoUrl = footerData.logoUrl;else if (_this.features.isConanCE()) {
	                        _this.logoUrl = "images/artifactory_conan_ce.1354.svg";
	                    } else if (_this.features.isEdgeNode()) {
	                        _this.logoUrl = "images/artifactory_edge.1354.svg";
	            ...
	            value: function initQuickActions(actionsController) {
	                ...
	                actionsController.setActions([{
	                    ...
	                    visibleWhen: function () {
	                        return !_this.features.isConanCE() && !_this.features.isEdgeNode();
	                    }
	                }, {
	                    name: "createVirtual",
	        ...
	        isSSOMode: {
	            value: function isSSOMode() {
	                return this.$state.current.name === "login" && !(this.features.isOss() || this.features.isConanCE());
	            }
	        }
	    });
	    ...
	    link: function link($scope, $element, $attrs) {
	      ...
	      if (!feature) {
	        ...
	        if (currentLicense === "OSS" || currentLicense === "ConanCE") {
	          ...
	          var edition = currentLicense === "ConanCE" ? "<br>Aritfactory Community Edition for C/C++" : "OSS";
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var SpecialValues = _interopRequire(__webpack_require__(114));
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var STORAGE_TYPES_DICTIONARY = _interopRequire(__webpack_require__(116));
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var fieldsValuesDictionary = _interopRequire(__webpack_require__(129));
	    ...
	    return {
	        ...
	        link: function jfRepokeyValidatorLink(scope, element, attrs, ngModel) {
	            ...
	            function validateRepoKey(modelValue, viewValue) {
	                ...
	                var remote = scope.controller.repoType == fieldsValuesDictionary.REPO_TYPE.REMOTE;
	
	                if (!repoKey) {
	                    return $q.when();
	                }
	
	                return RepositoriesDao.repoKeyValidator({ repoKey: repoKey, remote: remote }).$promise.then(function (result) {
	                    if (result.error) {
...
//# sourceMappingURL=artifactory_directives.js.1354.map