...
/***/ (function(module, exports, __webpack_require__) {
	...
	var ApiConstants = _interopRequire(__webpack_require__(93));
	
	var ArtifactoryCookies = __webpack_require__(142).ArtifactoryCookies;
	
	var ArtifactoryHttpClient = __webpack_require__(143).ArtifactoryHttpClient;
	
	var ArtifactoryStorage = __webpack_require__(144).ArtifactoryStorage;
	
	var ArtifactoryXmlParser = __webpack_require__(145).ArtifactoryXmlParser;
	
	var KeyboardShortcutsModalService = _interopRequire(__webpack_require__(146));
	
	var UserFactory = __webpack_require__(149).UserFactory;
	
	var ArtifactoryState = __webpack_require__(150).ArtifactoryState;
	
	var artifactorySessionInterceptor = __webpack_require__(151).artifactorySessionInterceptor;
	
	var artifactoryDebugInterceptor = __webpack_require__(152).artifactoryDebugInterceptor;
	
	var artifactorySpinnerInterceptor = __webpack_require__(153).artifactorySpinnerInterceptor;
	
	var artifactoryMessageInterceptor = __webpack_require__(154).artifactoryMessageInterceptor;
	
	var artifactoryServerErrorInterceptor = __webpack_require__(155).artifactoryServerErrorInterceptor;
	
	var ArtifactoryModelSaverFactory = __webpack_require__(156).ArtifactoryModelSaverFactory;
	
	var ArtifactoryFeatures = __webpack_require__(157).ArtifactoryFeatures;
	
	var GoogleAnalytics = __webpack_require__(158).GoogleAnalytics;
	
	var NativeBrowser = __webpack_require__(159).NativeBrowser;
	
	var ArtifactActions = __webpack_require__(160).ArtifactActions;
	
	var SetMeUpModal = __webpack_require__(163).SetMeUpModal;
	
	var ArtifactoryDeployModal = __webpack_require__(165).ArtifactoryDeployModal;
	
	var PushToBintrayModal = __webpack_require__(166).PushToBintrayModal;
	
	var parseUrl = __webpack_require__(167).parseUrl;
	
	var recursiveDirective = __webpack_require__(168).recursiveDirective;
	
	var ArtifactorySidebarDriver = __webpack_require__(169).ArtifactorySidebarDriver;
	
	var OnBoardingWizard = __webpack_require__(170).OnBoardingWizard;
	
	var SaveArtifactoryHaLicenses = __webpack_require__(171).SaveArtifactoryHaLicenses;
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _keyboard_shortcuts_serviceConstants = __webpack_require__(147);
	    ...
	    showhSortcutsModal: {
	      ...
	      value: function showhSortcutsModal() {
	        ...
	        if (!$(".shortcuts-modal").length) {
	          this.modalInstance = this.modal.launchModalWithTemplateMarkup(__webpack_require__(148), this.modalScope, 800, false);
	        }
	      }
	    }
	  });
...
/***/ (function(module, exports, __webpack_require__) {
	...
	function UserFactory(ArtifactoryHttpClient, ArtifactoryStorage, RESOURCE, $q, $window, $state, $timeout, $stateParams, JFrogEventBus, ArtifactoryFeatures, ArtifactoryState, FooterDao) {
...
/***/ (function(module, exports) {
	...
	var HIDDEN_EDGE_FEATURES = ["replications", "remote", "distribution", "builds", "xray", "licenses", "sslcertificates"];
	    ...
	    _createClass(ArtifactoryFeatures, {
	        ...
	        isEnabled: {
	            value: function isEnabled(feature) {
	                ...
	                if (LICENSES_LEVELS[currentLicense] === 1 && LICENSES_LEVELS[allowedLicense] === 1) {
	                    if (currentLicense === "ConanCE" && _.includes(["ivy", "sbt", "gradle", "maven"], feature)) {
	                        return false;
	                    }
	                    if (currentLicense === "OSS" && feature === "conan") {
	                        return false;
	                    }
	                }
	        ...
	        isNonCommercial: {
	            value: function isNonCommercial() {
	                return this.isOss() || this.isConanCE();
	            }
	        },
	        getFeatureName: {
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var API = _interopRequire(__webpack_require__(93));
	
	var EVENTS = _interopRequire(__webpack_require__(49));
	
	var ACTIONS = _interopRequire(__webpack_require__(161));
	
	var MESSAGES = _interopRequire(__webpack_require__(162));
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var SNIPPETS = _interopRequire(__webpack_require__(164));
	
	var FIELD_OPTIONS = _interopRequire(__webpack_require__(129));
	        ...
	        _removeDisabledFeatures: {
	            value: function _removeDisabledFeatures() {
	                ...
	                this.repoPackageTypes = _.filter(this.repoPackageTypes, function (item) {
	                    return !_this.artifactoryFeatures.isDisabled(item.value);
	                });
	            }
	        },
	        launch: {
...
/***/ (function(module, exports) {
	...
	var snippets = {
	    ...
	    conan: {
	        general: [{
	            before: "To add the repository to your conan CLI, use:",
	        ...
	        read: [{
	            before: "To install the dependencies defined in your project's <i>conanfile.txt</i> from an Artifactory conan repo, specify the remote:",
	            snippet: "conan install . -r <REMOTE>"
	        }],
	        deploy: [{
	            before: "To upload a recipe with its binary packages into an Artifactory repository use the following command:",
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var TOOLTIP = _interopRequire(__webpack_require__(101));
	...
	var ArtifactoryDeployModal = exports.ArtifactoryDeployModal = (function () {
	    function ArtifactoryDeployModal($rootScope, RepoDataDao, JFrogEventBus, JFrogModal, $timeout, JFrogUIUtils) {
	        ...
	        getMenuItems: {
	            value: function getMenuItems() {
	                return [{
	                    ...
	                    feature: "native-ui",
	                    isDisabled: !this.user.canView("packages") || this.features.isNonCommercial(),
	                    selected: false
	                }, {
	                    label: "Search",
	                    state: "search",
	                ...
	                this.footerDao.get(false).then(function (footerData) {
	                    ...
	                    adminItems.forEach(function (item) {
	                        ...
	                        item.subItems.forEach(function (subitem) {
	                            ...
	                            if (_this.features.isEdgeNode() && subitem.label === "Remote") {
	                                subitem.isHidden = true;
	                                return;
	                            }
	                            if (_this.features.isConanCE() && subitem.label === "Maven Indexer") {
	                                subitem.isHidden = true;
	                                return;
	                            }
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var fieldOptions = _interopRequire(__webpack_require__(129));
	
	var TOOLTIP = _interopRequire(__webpack_require__(101));
	
	var OnBoardingWizard = exports.OnBoardingWizard = (function () {
	    function OnBoardingWizard($timeout, $q, JFrogModal, FooterDao, ArtifactoryState, GoogleAnalytics, ArtifactoryFeatures, OnboardingDao, User, $state) {
	        ...
	        show: {
	            value: function show() {
	                ...
	                this.User.loadUser(true).then(function () {
	                    ...
	                    _this.FooterDao.get().then(function (footerData) {
	                ...
	                whenReady.then(function () {
	                    ...
	                    if (!quickSetup && !_this.initStatus.hasLicenseAlready && !_this.features.isAol() && !_this.features.isNonCommercial()) steps.push({
	                        name: "Activate Your Artifactory Instance",
	                        id: "license",
	                        icon: "images/wizard-icons/icon_1_idle_gif.1354.gif",
	                        iconSrcset: "images/wizard-icons/icon_1_idle_gif@2.1354.gif 2x, images/wizard-icons/icon_1_idle_gif@3.1354.gif 3x",
	                        buildIcon: "images/wizard-icons/icon_1_build_gif.1354.gif",
	                        buildIconSrcset: "images/wizard-icons/icon_1_build_gif@2.1354.gif 2x, images/wizard-icons/icon_1_build_gif@3.1354.gif 3x",
	                    ...
	                    if (!quickSetup && !_this.user.isAdmin() && _this.initStatus.hasPriorLogins) steps.push({
	                        name: "Admin Login",
	                        id: "login",
	                        icon: "images/wizard-icons/icon_2_idle_gif.1354.gif",
	                        iconSrcset: "images/wizard-icons/icon_2_idle_gif@2.1354.gif 2x, images/wizard-icons/icon_2_idle_gif@3.1354.gif 3x",
	                        buildIcon: "images/wizard-icons/icon_2_build_gif.1354.gif",
	                        buildIconSrcset: "images/wizard-icons/icon_2_build_gif@2.1354.gif 2x, images/wizard-icons/icon_2_build_gif@3.1354.gif 3x",
	                    ...
	                    if (!quickSetup && !_this.user.isAdmin() && !_this.initStatus.hasPriorLogins) steps.push({
	                        ...
	                        buildIcon: "images/wizard-icons/icon_2_build_gif.1354.gif",
	                        buildIconSrcset: "images/wizard-icons/icon_2_build_gif@2.1354.gif 2x, images/wizard-icons/icon_2_build_gif@3.1354.gif 3x",
	                        description: "This new password is for the default admin user.<br>" + "Want to skip? Find the default admin credentials in the " + "<a href=\"https://www.jfrog.com/confluence/display/RTF/Installing+Artifactory#InstallingArtifactory-DefaultAdminUser\" target=\"_blank\" class=\"jf-link nowrap\">" + "JFrog Artifactory User Guide <i class=\"icon icon-external-link\"></i>" + "</a>.",
	                        templateUrl: "modal_templates/onboarding_wizard/set_password.html",
	                        skippable: true,
	                        supportReturnTo: true
	                    });
	
	                    if (!quickSetup && !_this.features.isAol() && !_this.initStatus.hasProxies) steps.push({
	                        name: "Configure a Proxy Server",
	                        id: "proxy",
	                        icon: "images/wizard-icons/icon_3_idle_gif.1354.gif",
	                        iconSrcset: "images/wizard-icons/icon_3_idle_gif@2.1354.gif 2x, images/wizard-icons/icon_3_idle_gif@3.1354.gif 3x",
	                        buildIcon: "images/wizard-icons/icon_3_build_gif.1354.gif",
	                        buildIconSrcset: "images/wizard-icons/icon_3_build_gif@2.1354.gif 2x, images/wizard-icons/icon_3_build_gif@3.1354.gif 3x",
	                    ...
	                    steps.push({
	                        ...
	                        id: "packageTypes",
	                        icon: "images/wizard-icons/icon_4_idle_gif.1354.gif",
	                        iconSrcset: "images/wizard-icons/icon_4_idle_gif@2.1354.gif 2x, images/wizard-icons/icon_4_idle_gif@3.1354.gif 3x",
	                        buildIcon: "images/wizard-icons/icon_4_build_gif.1354.gif",
	                        buildIconSrcset: "images/wizard-icons/icon_4_build_gif@2.1354.gif 2x, images/wizard-icons/icon_4_build_gif@3.1354.gif 3x",
	                    ...
	                    steps.push({
	                        ...
	                        id: "summary",
	                        icon: "images/wizard-icons/icon_5_idle_gif.1354.gif",
	                        iconSrcset: "images/wizard-icons/icon_5_idle_gif@2.1354.gif 2x, images/wizard-icons/icon_5_idle_gif@3.1354.gif 3x",
	                        buildIcon: "images/wizard-icons/icon_5_build_gif.1354.gif",
	                        buildIconSrcset: "images/wizard-icons/icon_5_build_gif@2.1354.gif 2x, images/wizard-icons/icon_5_build_gif@3.1354.gif 3x",
	                        description: "Congrats! These are the default repositories we created for you.<br>" + "You’re now ready to speed up your software releases!<br>" + "Want to configure your client(s) and get started? Click the " + "<a href=\"https://www.jfrog.com/confluence/display/RTF/Using+Artifactory#UsingArtifactory-SetMeUp\" class=\"jf-link\" target=\"_blank\">" + "Set Me Up <i class=\"icon icon-external-link\"></i>" + "</a> button for each repository.<br>" + "Want to learn more about different repository types? Consult the " + "<a href=\"https://www.jfrog.com/confluence/display/RTF\" target=\"_blank\" class=\"jf-link nowrap\">" + "JFrog Artifactory User Guide <i class=\"icon icon-external-link\"></i>" + "</a>.",
	                    ...
	                    if (quickSetup) {
	                        ...
	                        step.name = "All Done!";
	                        step.description = "These are the default repositories we created for you.<br>" + "Want to configure your client(s) and get started? Click the <a href=\"https://www.jfrog.com/confluence/display/RTF/Using+Artifactory#UsingArtifactory-SetMeUp\" target=\"_blank\" class=\"jf-l\">Set Me Up</a> button for each repository.";
	                    }
	            ...
	            value: function isSystemOnboarding() {
	                ...
	                if (prevOnboarding === undefined) {
	                    ...
	                    this.OnboardingDao.initStatus({ $no_spinner: true }).$promise.then(function (status) {
	                        ...
	                        if (!_this.initStatus.hasPriorLogins || !_this.initStatus.hasLicenseAlready) {
	...
	var WizardController = (function () {
	    function WizardController($timeout, $q, ArtifactoryState, ArtifactoryStorage, User, RegisterProDao, JFrogEventBus, ProxiesDao, OnboardingDao, UserDao, FooterDao, SaveArtifactoryHaLicenses, GoogleAnalytics) {
	            ...
	            value: function initPackageTypesStep() {
	                ...
	                if (!this.gotPackageTypes) {
	                    this.OnboardingDao.reposStates().$promise.then(function (response) {
	                        ...
	                        _.map(_this.packageTypes.packages, function (pack) {
...
//# sourceMappingURL=artifactory_services.js.1354.map