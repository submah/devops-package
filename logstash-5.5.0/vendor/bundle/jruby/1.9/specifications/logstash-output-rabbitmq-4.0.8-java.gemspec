# -*- encoding: utf-8 -*-
# stub: logstash-output-rabbitmq 4.0.8 java lib
...
Gem::Specification.new do |s|
  ...
  if s.respond_to? :specification_version then
    ...
    if Gem::Version.new(Gem::VERSION) >= Gem::Version.new('1.2.0') then
      ...
      s.add_runtime_dependency(%q<logstash-mixin-rabbitmq_connection>, ["< 5.0.0", ">= 4.3.0"])
      ...
      s.add_dependency(%q<logstash-mixin-rabbitmq_connection>, ["< 5.0.0", ">= 4.3.0"])
